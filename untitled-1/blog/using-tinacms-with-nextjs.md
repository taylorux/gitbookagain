...
![tinacms editing gif](https://github.com/taylorux/tinacms.org/tree/ec3e5c1e5736454379815f45595441bd79d85a2d/gif/tina-nextjs.gif)
...
It's also worth noting that unlike Gatsby, Next.js does not currently have a plugin system. If you've previously looked at Tina's [Gatsby setup guide](https://github.com/taylorux/tinacms.org/tree/ec3e5c1e5736454379815f45595441bd79d85a2d/docs/gatsby/manual-setup/README.md), you'll see that we're utilizing a few different plugins to set up Tina. With Next.js, we'll need to write that boostrapping code directly into our project.
...
Now that the development server is running, navigate to [http://localhost:3000/](http://localhost:3000/) to check it out.
...
This will have Next use your custom server code instead if its default development server. Take a look at the [Next.js custom server docs](https://nextjs.org/docs#custom-server-and-routing) and [Tina's Next.js docs](https://github.com/taylorux/tinacms.org/tree/ec3e5c1e5736454379815f45595441bd79d85a2d/docs/nextjs/adding-backends/README.md) for more information.

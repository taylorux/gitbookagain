...
![tinacms-add-new-file-gif](https://github.com/taylorux/tinacms.org/tree/ec3e5c1e5736454379815f45595441bd79d85a2d/gif/add-new-blog.gif)
...
![tinacms-create-content-form](https://github.com/taylorux/tinacms.org/tree/ec3e5c1e5736454379815f45595441bd79d85a2d/img/content-creator-ex.jpg)
...
Instead of adding a ‘delete’ plugin, we simply need to pass a `delete-action` to the main form options. Head to a file where you have a Tina form configured in your project. This will typically be a template file that generates multiple posts, casestudies, etc. If you don’t have a Tina form configured in your project, learn more about creating forms with Gatsby+Tina [here](https://tinacms.org/docs/gatsby/manual-setup).
